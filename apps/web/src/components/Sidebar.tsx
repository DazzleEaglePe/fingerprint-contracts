  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-64 bg-[#040f0a] border-r border-[#0c2e1f]/50 flex flex-col h-screen
      ...
      `}>
        ...
        {/* Brand (Desktop only) */}
        <div className="h-20 hidden md:flex items-center gap-3 px-8 border-b border-white/5 relative overflow-hidden">
          ...
          <Leaf className="w-7 h-7 text-emerald-400 relative z-10" />
          <span className="font-semibold text-xl text-white tracking-wide relative z-10">DecData</span>
        </div>
      ...
      <div className="p-6 border-t border-white/5 relative z-10">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl text-red-400/80 hover:text-red-400 hover:bg-red-500/10 transition-all font-medium text-sm"
        >
